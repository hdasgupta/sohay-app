...
export const USERS = {
  admin: { id: 1, name: 'Administrator', email: 'wbffmh@gmail.com', role: 'admin' },
  patient: { id: 5, name: 'Rina Sen', email: 'rina@example.com', role: 'patient' },
  doctor: { id: 9, name: 'Dr. Amit Das', email: 'amit@example.com', role: 'doctor' },
};
