...
export default function AppointmentListPage() {
  ...
  const load = useCallback(async () => {
    try {
      setItems((await listAppointments()).data);
    } catch {
      setItems([]);
    }
  }, []);
    ...
    <div className="appt-list">
      <div className="page-title">
        <div>
          ...
          <p>
            Latest first. Includes appointments you booked for family members.
          </p>
        </div>
        <button
          type="button"
      ...
      {items && (
        <Pagination
          ...
          searchText={(a) =>
            `${a.doctorName} ${a.doctorSpeciality} ${a.patientName} ${a.status} ${a.date} ${formatDate(a.date)} ${a.startTime} #${a.id}`
          }
      ...
      <ConfirmDialog
        ...
        message={
          toCancel
            ? `Your appointment with ${toCancel.doctorName} on ${formatDate(toCancel.date)} will be cancelled and the slot released.`
            : ""
        }
