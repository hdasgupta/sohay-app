  ...
  return (
    ...
    >
      ...
      <g className="hg-body">
        ...
        <path
          d="M18 9h28c0 10-8 15-11 23 3 8 11 13 11 23H18c0-10 8-15 11-23-3-8-11-13-11-23z"
          className="hg-glass"
        />
        <path
          className="hg-top"
          d="M21 12h22c-1 6-6 10-11 17-5-7-10-11-11-17z"
          fill="url(#hg-sand)"
        />
        <path
          className="hg-bottom"
          d="M20 53h24c-1-7-6-11-12-15-6 4-11 8-12 15z"
          fill="url(#hg-sand)"
        />
        <line
          className="hg-stream"
