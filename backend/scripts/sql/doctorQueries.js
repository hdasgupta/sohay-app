...
export const medicineSearch =
  "SELECT id,name FROM medicines WHERE LOWER(name) LIKE LOWER($1) ORDER BY name LIMIT $2";
export const insertMedicine =
  "INSERT INTO medicines(name) VALUES($1) ON CONFLICT(name) DO NOTHING";
export const createPrescription =
  "INSERT INTO prescriptions(appointment_id,doctor_id,patient_id,patient_age,issued_on,pdf_key,pdf_url) VALUES($1,$2,$3,$4,$5,$6,$7) RETURNING id";
export const createPrescriptionMedicine =
  "INSERT INTO prescription_medicines(prescription_id,medicine_name,dose,instruction,timing,sos,food_timing,sort_order) VALUES($1,$2,$3,$4,$5,$6,$7,$8)";
...
export const prescriptionMedicines =
  "SELECT medicine_name,dose,instruction,timing,sos,food_timing,sort_order FROM prescription_medicines WHERE prescription_id=$1 ORDER BY sort_order";
export const prescriptionOwner =
  "SELECT id,patient_id,doctor_id,pdf_key,pdf_url FROM prescriptions WHERE id=$1 LIMIT $2";
export const updatePrescriptionPdfUrl =
  "UPDATE prescriptions SET pdf_url=$1 WHERE id=$2";
export const completeAppointment =
  "UPDATE appointments SET status=$1,active_doctor_slot_key=NULL,active_patient_slot_key=NULL,updated_at=NOW() WHERE id=$2";
