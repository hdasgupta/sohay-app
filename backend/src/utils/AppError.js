...
export default class AppError extends Error {
  ...
  static unauthorized(msg = 'Please login to continue') { return new AppError(msg, 401); }
  static forbidden(msg = 'You are not allowed to perform this action') { return new AppError(msg, 403); }
